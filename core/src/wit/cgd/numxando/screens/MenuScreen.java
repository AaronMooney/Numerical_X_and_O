 ...
 * @brief       Controls the menu screen of the game
 *
 * @notes       
 * 				
 */
...
public class MenuScreen extends AbstractGameScreen {
    ...
    private void rebuildStage() {
        ...
        optionsWindowLayer.setVisible(false);
    ...
    private Table buildStatsLayer() {
        ...
        table.row();
        table.row();
        undoLabel = new Label("Press 'R' to Undo a move", skin);
        table.add(undoLabel).right();
        table.row();
        undoLabel = new Label("Press 'H' for a hint", skin);
        table.add(undoLabel).right();
